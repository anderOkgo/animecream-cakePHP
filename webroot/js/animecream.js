 $(document).ready(function() {
  ...
  $("#selector").change(function() {
    ...
    localStorage.setItem("listaActual", $("#selector option:selected").text());
  });
  ...
  $("#borrar").click(function() {
    ...
    if ($("#selector option:selected").text()=="") {
     ...
     $("#dialog-confirm").append('<p><span class="ui-icon ui-icon-alert"></span>¿Desea eliminar esta lista?</p>');
   }
  ...
  $("#ordenar").click(function() {
    ...
    $( "#sortable li span" ).attr("class","ui-icon ui-icon-arrowthick-2-n-s");
  ...
  function agregarRegistro(id,nombre) {
    ...
    var final="";
    if ($("#selector option:selected").text()=="") {
      alert('Por Favor, agrega una lista nueva en el panel: "Mis listas" ');
      irZona();
    }else{
      ...
      $("#sortable").append('<li id="' +id +'" class="ui-sortable-handle"><span ></span>' +nombre +"</li>");
  ...
  function actulizarLista() {
    if ($("#selector option:selected").text()=="") {
      ...
      var cadena="lista";
      var strg = localStorage.getItem($("#selector option:selected").text());
      if (!strg || strg=="*") {
        strg = "*";
        localStorage.setItem($("#selector option:selected").text(),"*");
      }
      if (strg !== "*") {
        res = strg.replace("*-~-", "");
        array = res.split("-~-");
  ...
  function imprimirLista(lista) {
    ...
    if (strg !== "*") {
      ...
      $.each(array, function(index, value) {
        ...
        $("#sortable").append('<li id="' +val.id +'" class="ui-sortable-handle"><span ></span>' +val.nombre +"</li>");
      });
  ...
  function cambiarG(){
    ...
    if (URLactual=="https://www.animecream.com/" || URLactual=="https://www.animecream.com/?utm_source=homescreen" || URLactual=="https://animecream.com/" || URLactual=="https://animecream.com/?utm_source=homescreen") {
  ...
  function buscar(){
    window.location.href = "/producciones/" +'nombre-'+ $("#InpBuscar").val();
  }
